...
/// Home 카드용 — 모든 active 캠페인 summary. BUG-024:
/// 기간 필터링 (시작 전 / 진행 중 / 종료 후 분류) 은 frontend 가 매초
/// 시계로 처리 — 페이지 reload 없이 카드 자동 이동 + 카운트다운 표시.
/// SQL 은 단순히 status='active' alive 만 반환.
